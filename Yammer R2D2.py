...
# boucle decoute et reponse aux messages prives
while True:

 if yammer.messages.private(limit=1).message_id!=lastmessage
  lastmessageuser=yammer.messages.private(limit=1).user_id  
