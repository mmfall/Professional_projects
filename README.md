...
# Organisation RH du Cargo (pas complet car macro_activite Autres support transverses (permanences syndicale exemple Michel Raynard) etc. vue trop partielle, il faut sortir tous les liens +1 des RH pour ne pas tirer de mauvaises conclusions
MATCH (CCO {Nom:"MALKA ALAIN"})-[:MANAGER_OF*0..10]->(Person {Macro_activite:"RESSOURCES HUMAINES"}) RETURN *
```
